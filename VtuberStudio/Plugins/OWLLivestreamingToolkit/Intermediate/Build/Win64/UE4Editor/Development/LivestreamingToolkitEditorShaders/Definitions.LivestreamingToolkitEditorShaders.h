#undef LIVESTREAMINGTOOLKITEDITORSHADERS_API
...
#define UE_PROJECT_NAME UE_VtuberStudio
#define UE_TARGET_NAME UE_VtuberStudioEditor
#define UE_MODULE_NAME "LivestreamingToolkitEditorShaders"
...
#define LIVESTREAMINGTOOLKITEDITORSHADERS_API DLLEXPORT
