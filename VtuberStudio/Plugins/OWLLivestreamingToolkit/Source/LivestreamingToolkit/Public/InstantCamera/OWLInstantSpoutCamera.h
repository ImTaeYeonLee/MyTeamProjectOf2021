...
#include "OWLInstantSpoutCamera.generated.h"
...
UCLASS()
class LIVESTREAMINGTOOLKIT_API AOWLInstantSpoutCamera : public AActor
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	AOWLInstantSpoutCamera(const FObjectInitializer& ObjectInitializer);

public:
	/* Name by which the camera can be identified in OBS */
	UPROPERTY(EditAnywhere, Category = "Off World Live Instant Spout Camera Settings", meta = (DisplayPriority = "2"))
	FString CameraName;

	UFUNCTION(BlueprintCallable, Category = "Off World Live Instant Spout Camera Settings")
	FString GetCameraName();

	/* Name by which the camera can be identified in OBS */
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Off World Live Instant Spout Camera Settings", meta = (DisplayPriority = "2"))
	...
	/* Texture resolution for camera render output */
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Off World Live Instant Spout Camera Settings", meta = (editcondition = "!UseCustomStreamResolution", DisplayPriority = "2"))
	...
	/* Texture resolution for camera render output */
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Off World Live Instant Spout Camera Settings", meta = (editcondition = "UseCustomStreamResolution", ClampMin = "1", DisplayPriority = "2"))
