...
class LIVESTREAMINGTOOLKIT_API UOWLCaptureComponent : public USceneComponent
{
	GENERATED_BODY()
...
public:
	UFUNCTION(BlueprintPure, Category = "Rendering|OWLCapture")
	UCameraComponent* GetTargetCamera() const;

	/** Adds the component to our list of hidden components. */
	UFUNCTION(BlueprintCallable, Category = "Rendering|OWLCapture")
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Rendering|UMGRendering")
