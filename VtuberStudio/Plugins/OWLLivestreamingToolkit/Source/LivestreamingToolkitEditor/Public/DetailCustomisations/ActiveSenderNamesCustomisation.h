...
class FActiveSenderNames
{
public:
	static FActiveSenderNames& Get();
...
class FActiveSenderNamesCustomisation : public IPropertyTypeCustomization
{
public:
	FActiveSenderNamesCustomisation();
...
protected:
	...
	TSharedPtr<IPropertyHandle> UseFirstAvaibleSenderProperty;
